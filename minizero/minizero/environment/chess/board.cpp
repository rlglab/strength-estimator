...
static std::mutex attacks_table_mutex;
static bool attacks_table_built = false;
...
#endif
    std::lock_guard<std::mutex> lock(attacks_table_mutex);
    if(attacks_table_built)
        return;
